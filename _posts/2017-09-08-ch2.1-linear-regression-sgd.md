...
{:.image-caption}
Left: 1-variable gradient descent. Right: multivariable gradient descent, with
...
is the learning rate, and it affects how quickly m changes. Set $\alpha$ (learning rate) too small and gradient descent will take a long time to reach the minimum. However, set α too large and gradient descent might even diverge.
