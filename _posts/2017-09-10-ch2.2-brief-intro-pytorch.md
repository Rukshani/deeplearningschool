...
But what does that really mean? The concept of **differentiable circuits** is key to reasoning about complex machine learning pipelines. (This is a non-standard term, inspired by Karpathy's [Hacker's Guide To Neural Networks](http://karpathy.github.io/neuralnets/)). Essentially, you can imagine a circuit of 
